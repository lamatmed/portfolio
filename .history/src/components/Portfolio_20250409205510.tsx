        ...
        <main className="grid grid-cols-12 gap-8">
          <div className="col-span-4">
            ...
            >
              ...
              >
               Développeur fullstack passionné, spécialisé en Next.js pour le web et React Native pour le mobile. J’aime créer des interfaces modernes, performantes et intuitives, aussi bien côté client que serveur. Je suis autonome, rigoureux, et j'adore relever de nouveaux défis techniques.
              </p>
