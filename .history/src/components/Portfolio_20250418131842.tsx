      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 justify-between w-full">
            <nav
              className="flex gap-1 p-1 rounded-xl backdrop-blur-sm overflow-x-auto max-w-full sm:flex-nowrap flex-grow"
              style={{
            ...
            >
              {["about", "projects", "experience", "CV"].map((section) => (
                <button
                  ...
                  className={`whitespace-nowrap px-4 py-2 rounded-lg transition-all capitalize text-sm font-medium
