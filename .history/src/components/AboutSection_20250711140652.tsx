          ...
          <div className="md:w-1/2 order-1 md:order-2">
            ...
            <div className="space-y-4">
              <p>
                ...
                Je suis titulaire d'un master en systèmes intelligents mobiles et je possède 10 ans d'expérience dans le développement web et mobile.
              </p>
              
              <p>
                Je me spécialise dans le développement full-stack avec une expertise en Python, php, JavaScript et les technologies web modernes.
                Mes compétences techniques incluent React.js, Next.js, Node.j, React Native et diverses bases de données comme MongoDB et MySQL et Prisma.
