      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col items-center text-center animate-fade-in">
          ...
          <p className="text-lg max-w-2xl mb-8 text-muted-foreground">
            Développeur logiciel passionné, compétent en Python, php, Java et développement full-stack, avec de solides capacités de collaboration et de leadership en équipe.
          </p>
