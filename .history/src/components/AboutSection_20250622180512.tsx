        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="md:w-1/2 order-1 md:order-2">
            ...
            <div className="space-y-4">
              <p>
                Bonjour ! Je suis Maniteja Lenkalapelly, un développeur logiciel passionné originaire d'Hyderabad, en Inde.
                Je poursuis actuellement un Bachelor of Technology en informatique à
                VNR Vignana Jyothi Institute of Engineering and Technology avec un CGPA de 9,1.
              </p>
